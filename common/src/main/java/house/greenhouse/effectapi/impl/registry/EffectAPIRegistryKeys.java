...
public class EffectAPIRegistryKeys {
    public static final ResourceKey<Registry<ActionType<?>>> ACTION_TYPE = ResourceKey.createRegistryKey(EffectAPI.asResource("action_type"));
    public static final ResourceKey<Registry<DataType<?>>> DATA_TYPE = ResourceKey.createRegistryKey(EffectAPI.asResource("data_type"));
    public static final ResourceKey<Registry<EffectType<?>>> EFFECT_TYPE = ResourceKey.createRegistryKey(EffectAPI.asResource("effect_type"));
