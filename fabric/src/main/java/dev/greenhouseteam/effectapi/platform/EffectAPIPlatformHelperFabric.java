...
public class EffectAPIPlatformHelperFabric implements EffectAPIPlatformHelper {
    ...
    @Override
    @Nullable
    public EffectsAttachment getEffects(Entity entity) {
        return entity.getAttached(EffectAPIAttachments.EFFECTS);
    }

    @Override
    public void addEffect(Entity entity, EffectAPIEffect effect, EffectSource source) {
    ...
    @Override
    public void removeEffect(Entity entity, EffectAPIEffect effect, EffectSource source) {
    ...
    @Override
    public void setEffects(Entity entity, Map<EffectSource, DataComponentMap> allEffects, DataComponentMap activeEffects) {
        EffectsAttachment attachment = entity.getAttachedOrCreate(EffectAPIAttachments.EFFECTS);
        attachment.init(entity);
        attachment.setComponents(allEffects, activeEffects);
        if (attachment.isEmpty())
            entity.removeAttached(EffectAPIAttachments.EFFECTS);
    }
