...
public record EntityResourceEffect<T>(ResourceLocation id, Codec<T> resourceType,
    ...
    public void onAdded(LootContext lootContext) {
        ...
        EffectAPIEntity.getHelper().sendClientboundTracking(new ChangeResourceClientboundPacket<>(entity.getId(), this, Optional.ofNullable(lootContext.getParamOrNull(EffectAPILootContextParams.SOURCE)), Optional.of(value)), entity);
    }
    ...
    public void onRemoved(LootContext lootContext) {
        ...
        EffectAPIEntity.getHelper().sendClientboundTracking(new ChangeResourceClientboundPacket<>(entity.getId(), this, Optional.empty(), Optional.empty()), entity);
    }
